...
def factors():
    ...
    print("<factors_conv> 'watches' - Active NWS tornado and severe thunderstorm watches at the given time.")
    print("<factors_conv> 'svrwatches' - Active NWS severe thunderstorm watches at the given time.")
    print("<factors_conv> 'torwatches' - Active NWS tornado watches at the given time.")
    print("<factors_conv> 'reports' - Local storm reports for within 15 minutes of the given time.")
    print("<factors_conv> 'hailreports' - Local hail reports for within 15 minutes of the given time.")
    print("<factors_conv> 'torreports' - Local tornado reports for within 15 minutes of the given time.")
...
def Retrieve(Time, factors, values):
    ...
    try:
        ...
        print("<warning> Warnings are not available for this time!")
    try:
        try:
        ...
        print("<warning> Watches are not available for this time!")
    try:
        try:
        ...
        print("<warning> Reports are not available for this time!")
